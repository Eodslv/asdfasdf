...
def JPEventHBorderData() :
    BorderLink = requests.get('https://api.matsurihi.me/mltd/v1/events/%s/rankings/logs/highscore/%s'%(LastEventData['id'],'1,100,2000,5000'))
    __Temp = BorderLink.json()
    return __Temp[0]['data'][-1]['summaryTime'],__Temp[0]['data'][-1]['score'], __Temp[1]['data'][-1]['score'], __Temp[2]['data'][-1]['score'], __Temp[3]['data'][-1]['score']
...
token = "NzAyODA1Nzg1NzM0MDIxMTkx.XqUE2g.-LA0jDCLMyIPG1ePsJnVna0Evzs"
